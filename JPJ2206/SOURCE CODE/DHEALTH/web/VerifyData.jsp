...
<html lang="en">
    <head>
        <title>DHEALTH – A Distributed Privacy-Preserving Framework for 
Smart Healthcare Systems</title>
        <meta charset="UTF-8">
    ...
    <body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
        ...
        <section class="navbar navbar-default navbar-static-top" role="navigation">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="#" class="navbar-brand"><i class="fa fa-h-square"></i>&nbsp;DHEALTH</a> 
                </div>
        ...
        <%
            ...
            ResultSet rs = st.executeQuery("Select * from patientshare where pid ='" + pid + "' And  id = '" +sid+ "' ");
            rs.next();
            String skey = rs.getString("dkey");
            String rkey = rs.getString("rkey");
            String reencfile = rs.getString("reencfile");
            
            System.out.println("key " + skey);

            
            keyValue = rkey.getBytes();
           
            String updata1 = decryption(reencfile);

            if (rkey.equalsIgnoreCase(checkkey) == false) {
                response.sendRedirect("SharedPatients.jsp?Incorrect");
            }
            keyValue = skey.getBytes();
           
            String updata = decryption(updata1);
                    ...
                    <div class="col-md-12 col-sm-6">
                        ...
                        <form id="appointment-form" role="form" method="post" action="MedicaldataUpdate">
                            ...
                            <div class="section-title wow fadeInUp" data-wow-delay="0.4s">
                                <center><h2>Shared Patient data</h2></center>
                    ...
                    <div class="col-md-12 col-sm-12 border-top">
                        <div class="col-md-4 col-sm-6">
                            <div class="copyright-text"> 
                                <p>Copyright &copy; 2026 e-Healthcare System 
                            </div>
                        </div>
