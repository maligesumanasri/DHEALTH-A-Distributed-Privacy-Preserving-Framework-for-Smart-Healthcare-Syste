...
Smart Healthcare Systems</title>
    ...
    <body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
        ...
        <section id="appointment" data-stellar-background-ratio="3">
            <div class="container">
                <div class="row">
                        <center><h2>Share Patients Details to another Doctor</h2></center>
                    <br><br>
                    <form  action="ShareDoctor" method="post">
                        ...
                        <div class="control-group">
                            <select class="form-control" required="" name="pid">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <%
                                    try {
                                        ResultSet rs1 = st.executeQuery("Select * from doctors where ustatus ='Active' and id<>'"+did+"'");
                                            while (rs1.next()) {
                        ...
                        <div class="col-md-4 col-md-offset-4">
                            <button type="submit" class="form-control" id="cf-submit" name="submit">share</button>
                        </div>
                    </form>
