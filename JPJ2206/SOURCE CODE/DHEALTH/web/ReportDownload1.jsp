          ...
          <div class="container">
               <div class="row">
                    <div class="col-md-6 col-md-offset-4">
                         <!-- CONTACT FORM HERE -->
                         <center><form id="appointment-form" role="form" method="post" action="VerifyData.jsp">
                              ...
                              <div class="wow fadeInUp" data-wow-delay="0.8s">
                                   <div class="col-md-12 col-sm-12">
                                        ...
                                        <label for="name">Decryption Key</label>
                                        <input type="password" class="form-control" id="name" name="ss" placeholder="Decryption Key">
