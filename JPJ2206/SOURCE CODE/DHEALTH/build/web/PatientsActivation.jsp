...
Smart Healthcare Systems</title>
    ...
    <body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
     ...
     <section id="appointment" data-stellar-background-ratio="3">
          <div class="container">
               <div class="row">
                   <center><h1>Patients Activation</h1></center>
                        <br> <br> <br>
                        <table id="naresh" style="margin: auto;padding: 10px;">
                            ...
                            <%
                                ...
                                try {
                                    ResultSet rs = st.executeQuery("Select * from patients where ustatus ='No'");
                                    while (rs.next()) {
                            %>
                            <tr>
                                ...
                                <td><a href="ActivatePatient?uid=<%=rs.getString("id")%>"  class="btn btn-success" style="color: white">&nbsp;Approve</a>&nbsp;&nbsp;
                                    <a href="RejectPatient?uid=<%=rs.getString("id")%>"   class="btn btn-danger" style="color: white">&nbsp;Reject</a></td>
                            </tr>
                            <%                                        }
                                } catch (Exception ex) {
                                    ex.printStackTrace();
